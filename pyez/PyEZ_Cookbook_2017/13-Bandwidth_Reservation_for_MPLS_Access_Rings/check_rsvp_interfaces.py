...
def get_rsvp(_IP1):
	...
	for rsvp in rsvp_int_T:
		file_log.write(_IP1 + ";" + rsvp.interface_name + ";" + rsvp.rsvp_status + ";" + rsvp.rsvp_telink_active_reservation + ";" + rsvp.rsvp_telink_subscription + ";" + rsvp.rsvp_telink_available_bandwidth + '\n')
